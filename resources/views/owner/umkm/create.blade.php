        ...
        <div class="flex flex-wrap items-end justify-between gap-x-8 gap-y-3">
            <div class="min-w-0">
                ...
                <p class="mt-1 text-sm text-[#8A7464] sm:text-base">
                    Lengkapi data usaha Anda untuk mendaftarkan UMKM baru.
                </p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="container-page">
            <ol class="flex flex-wrap items-center gap-x-3 gap-y-2 text-sm">
                <li class="flex items-center gap-2">
                    ...
                    <span class="font-medium text-[#3F2A22]">Isi Data UMKM</span>
                </li>
                ...
                <div class="p-6 sm:p-8">
                    <div class="rounded-xl bg-[#FAF6F5] p-4 ring-1 ring-[#ECE5D9]">
                        <p class="text-sm text-[#6F5D50]">
                            Isi data UMKM Anda dengan lengkap. Data akan disimpan sebagai <span class="font-semibold text-[#3F2A22]">draft</span>, lalu Anda dapat mengirimkannya untuk diperiksa Administrator.
                        </p>
                        <p class="mt-1 text-xs text-[#8A7464]">
                            Kolom bertanda <span class="font-semibold text-[#C26A4A]">*</span> wajib diisi. Kolom lainnya opsional dan dapat dilengkapi kapan saja.
                        </p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('owner.umkm.store') }}" class="mt-6">
                        ...
                        <section class="space-y-5">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-[#8A7464]">Identitas dasar UMKM Anda</p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                <div class="sm:col-span-2">
                                    ...
                                    <x-owner-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus placeholder="Contoh: Warung Maju" />
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <x-owner-textarea id="description" name="description" rows="4" class="mt-1 block w-full" placeholder="Jelaskan usaha Anda secara singkat">{{ old('description') }}</x-textarea>
                        ...
                        <section class="mt-8 space-y-5">
                            ...
                            <div>
                                ...
                                <x-owner-textarea id="address" name="address" rows="3" class="mt-1 block w-full" placeholder="Alamat lengkap usaha">{{ old('address') }}</x-textarea>
                            ...
                            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                <div>
                                    ...
                                    <x-owner-text-input id="google_maps" class="block mt-1 w-full" type="text" name="google_maps" :value="old('google_maps')" placeholder="Contoh: https://maps.app.goo.gl/xxxxx" />
                                ...
                                <div>
                                    ...
                                    <x-owner-text-input id="operational_hours" class="block mt-1 w-full" type="text" name="operational_hours" :value="old('operational_hours')" placeholder="Contoh: 08.00 - 17.00" />
                        ...
                        <section class="mt-8 space-y-5">
                            ...
                            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                <div>
                                    ...
                                    <x-owner-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone')" placeholder="Contoh: 0812-3456-7890" />
                                    <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                                </div>

                                <div>
                                    <x-owner-input-label for="email" :value="__('Email')" />
                                    <x-owner-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" placeholder="Contoh: usaha@email.com" />
                            ...
                            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                <div>
                                    ...
                                    <x-owner-text-input id="website" class="block mt-1 w-full" type="text" name="website" :value="old('website')" placeholder="Contoh: https://usaha.com" />
                                    <x-input-error :messages="$errors->get('website')" class="mt-2" />
                                </div>

                                <div>
                                    <x-owner-input-label for="instagram" :value="__('Instagram')" />
                                    <x-owner-text-input id="instagram" class="block mt-1 w-full" type="text" name="instagram" :value="old('instagram')" placeholder="Contoh: @nama.usaha" />
                            ...
                            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                <div>
                                    ...
                                    <x-owner-text-input id="facebook" class="block mt-1 w-full" type="text" name="facebook" :value="old('facebook')" placeholder="Contoh: nama.usaha" />
                                    <x-input-error :messages="$errors->get('facebook')" class="mt-2" />
                                </div>

                                <div>
                                    <x-owner-input-label for="tiktok" :value="__('TikTok')" />
                                    <x-owner-text-input id="tiktok" class="block mt-1 w-full" type="text" name="tiktok" :value="old('tiktok')" placeholder="Contoh: @nama.usaha" />
