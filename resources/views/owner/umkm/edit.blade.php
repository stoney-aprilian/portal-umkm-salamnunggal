<x-app-layout title="{{ $umkm->status === 'draft' ? __('Ubah UMKM') : __('Perbaiki UMKM') }}">
    <x-slot name="header">
    ...
    <div class="py-6 sm:py-8">
        <div class="container-page">
                ...
                <div class="mb-6 overflow-hidden rounded-2xl bg-red-50 shadow-[0_2px_12px_rgba(63,42,34,0.06)] ring-1 ring-red-200">
                    <div class="p-6 sm:p-8">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="min-w-0">
                                <h3 class="text-sm font-semibold text-red-900">Pengajuan UMKM Anda ditolak.</h3>
                ...
                <div class="mb-6 overflow-hidden rounded-2xl bg-amber-50 shadow-[0_2px_12px_rgba(63,42,34,0.06)] ring-1 ring-amber-200">
                    <div class="p-6 sm:p-8">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="min-w-0">
                                <h3 class="text-sm font-semibold text-amber-900">Pengajuan UMKM Anda perlu diperbaiki.</h3>
                ...
                <div class="p-6 sm:p-8">
                    @if ($umkm->status === 'draft')
                        <div class="flex items-start gap-4">
                            ...
                            <div class="min-w-0">
                                <h3 class="text-sm font-semibold text-[#3F2A22]">UMKM masih berupa draft</h3>
                                ...
                                <p class="mt-1 text-sm font-medium text-[#C26A4A]">
            ...
            <div class="overflow-hidden rounded-2xl bg-white shadow-[0_2px_12px_rgba(63,42,34,0.06)] ring-1 ring-[#ECE5D9]">
                <div class="p-6 sm:p-8">
                    <form method="POST" action="{{ route('owner.umkm.update', $umkm) }}" class="space-y-8">
                        @csrf
                        @method('PUT')
            ...
            <section class="mt-6 overflow-hidden rounded-2xl bg-white shadow-[0_2px_12px_rgba(63,42,34,0.06)] ring-1 ring-[#ECE5D9]">
                <div class="p-6 sm:p-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-sm font-semibold uppercase tracking-wider text-[#3F2A22]">Media UMKM</h2>
                            <p class="text-xs text-[#8A7464]">Logo, banner, dan galeri foto usaha</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <div class="rounded-xl border border-[#ECE5D9] bg-[#FAF6F5] p-5">
                            <div class="flex items-baseline justify-between gap-3">
                                <h3 class="text-sm font-semibold text-[#3F2A22]">Galeri</h3>
                            ...
                            <div class="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-3">
                                ...
                                @empty
                                    <p class="col-span-full mt-0 text-sm text-[#8A7464]">Belum ada foto galeri.</p>
                                @endforelse
                            </div>
