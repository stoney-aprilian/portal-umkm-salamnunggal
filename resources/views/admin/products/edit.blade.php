<x-app-layout :title="$product->name . ' — Edit Produk'">
    <div class="py-8 sm:py-10">
        <div class="container-page">
            <a href="{{ route('admin.products.show', $product) }}" class="inline-flex items-center gap-1.5 text-sm font-medium text-[#8A7464] transition-colors duration-150 hover:text-[#5C4033] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C26A4A] focus-visible:ring-offset-2">
            ...
            <div class="mt-6">
                ...
                <p class="mt-1 text-sm text-slate-600">Perbarui informasi produk milik UMKM <span class="font-semibold text-slate-900">{{ $product->umkm?->name ?? '—' }}</span>. Status produk tidak berubah dengan pengeditan ini.</p>
            </div>
                ...
                <div class="rounded-2xl bg-white shadow-sm">
                    ...
                    <div class="space-y-5 p-5 sm:p-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="price" name="price" type="text" class="mt-1 block w-full" value="{{ old('price', $product->price) }}" placeholder="Contoh: 50000" required />
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" class="mt-1 block w-full rounded-xl border border-slate-300 bg-white py-2.5 px-3 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#C26A4A] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C26A4A] focus-visible:ring-offset-2">{{ old('description', $product->description) }}</textarea>
