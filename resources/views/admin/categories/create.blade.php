<x-app-layout :title="'Tambah Kategori ' . ($type === 'umkm' ? 'UMKM' : 'Produk')">
    <div class="py-8 sm:py-10">
        <div class="container-page">
            ...
            <div class="mt-6">
                <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Tambah Kategori {{ $type === 'umkm' ? 'UMKM' : 'Produk' }}</h1>
                <p class="mt-1 text-sm text-slate-600">Kategori ini hanya dapat digunakan oleh {{ $type === 'umkm' ? 'UMKM' : 'produk' }}. Slug dibuat otomatis dari nama.</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.categories.store', $type) }}" class="mt-6 space-y-6">
                @csrf
                ...
                <div class="rounded-2xl bg-white shadow-sm">
                    <div class="border-b border-slate-100 px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-base font-semibold text-slate-900">Kategori {{ $type === 'umkm' ? 'UMKM' : 'Produk' }}</h2>
